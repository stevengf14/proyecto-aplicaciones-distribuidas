...
public class serv_Menu_Contabilidad extends HttpServlet {
    ...
    public String desplegarPantallaMenu() {
        ...
        ls_pantalla += "<a href='http://localhost:8080/distribuidas/serv_tipo_cuenta'><input type='submit' name='boton' value='Tipo Cuenta'></a>";
        ls_pantalla += "</br>";
        ls_pantalla += "<a href='http://localhost:8080/distribuidas/serv_cuenta'><input type='submit' name='boton' value='Cuenta'></a>";
        ls_pantalla += "</br>";
        ls_pantalla += "<a href='http://localhost:8080/distribuidas/serv_comprobante'><input type='submit' name='boton' value='Comprobante'></a>";
        ls_pantalla += "</br>";
